# Reference-driver burst-guard A/B experiment

The public `mfg92/hantek1008py` burst-mode path sends `E4 01` and `E6 01`
...
2. identical acquisition plus only the E4/E6 burst guards.
