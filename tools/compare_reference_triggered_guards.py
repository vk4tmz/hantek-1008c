#!/usr/bin/env python3
"""Controlled A/B capture for public hantek1008py triggered guard commands.
...
adding E4 01 / E6 01 immediately before and after the Triggered acquisition.
"""
...
def main():
    run([], "ref-ab-current")
    run(["--reference-triggered-guards"], "ref-ab-e4e6")
